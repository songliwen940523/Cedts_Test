...
namespace Cedts_Test.Areas.Admin.Models
{
    public interface ICedts_ItemRepository
    {
        ...
        /// 添加信息匹配
        /// </summary>
        /// <param name="Rpc">阅读理解-信息匹配</param>
        void AddInfMItem(InfoMatchingCompletion InfM);
        ...
        InfoMatchingCompletion SelectInfoMatch(Guid id);
        ...
        void EditInfoMatch(InfoMatchingCompletion InfoMatch);
