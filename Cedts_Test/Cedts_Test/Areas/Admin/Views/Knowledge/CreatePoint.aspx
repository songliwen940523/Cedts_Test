...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                remote:
                 {
                     ...
                     data: { Title: function () { return $("#Title").val(); }, type: function () { return 3; } },
                     dataType: "html",
                     dataFilter: function (data) { if (data == "False") return true; else return false; }
                 },
                messages: { required: "必填项，不能为空。", remote: "名称已经存在，请更换名称。" }
            });
    ...
    <div id="menu">
        ...
        =>
        <%:Html.ActionLink("新增知识点能力","CreatePoint") %>
    </div>
    <fieldset>
        <legend>新增知识点能力：</legend>
