...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.post("/admin/paper/GetInfoMatching", null, function (data) {
                if (data == "1") { }
                else {
    ...
    <div>
        ...
        <div id="menu">
            ...
            =>
            <%:Html.ActionLink("试卷信息匹配题型添加","CreateInfoMatching") %>
        </div>
        ...
        <input type="hidden" id="hidden" name="hidden" value='<%:ViewData["信息匹配题型"] %>' />
