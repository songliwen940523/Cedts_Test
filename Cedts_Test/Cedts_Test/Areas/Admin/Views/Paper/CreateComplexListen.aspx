...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            for (var i = 1; i <= itemNum; i++) {
                ...
                div_1 += "<div>";
                div_1 += "填空题数目：<select name='selectnum" + "_" + i + "'" + " id='selectnum" + "_" + i + "'" + " class='selectnum' style='width: 137px'>";
                div_1 += "<option>0</option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option></select><br />";
            ...
            $(".selectnum").live("change", function selctChange() {
                ...
                for (var j = 1; j <= selectnum; j++) {
                    ...
                    div_2 += "答案：&nbsp;<input type='text' id='answer" + tempnum + "_" + j + "'" + " name='answer" + tempnum + "_" + j + "'" + " class='answer' /><br />";
            ...
            //上一步时为元素赋值
            $.post("/admin/paper/GetComplexListen", null, function (data) {
                if (data == "1") { }
                else {
                    $("#filename").val("");
                    for (var i = 1; i <= data.length; i++) {
                        ...
                        for (var j = 1; j <= data[i - 1].Info.QuestionCount; j++) {
                            ...
                            $("#answer" + i + "_" + j).val(data[i - 1].Info.AnswerValue[j - 1].toString());
    ...
    <div>
        ...
        <div id="menu">
            ...
            =>
            <%:Html.ActionLink("试卷复合型听力添加","CreateComplexListen") %>
        </div>
        ...
        <input type="hidden" id="hidden" name="hidden" value='<%:ViewData["复合型听力"] %>' />
        ...
        <div>
            <div>
                <h3>
                    您当前选择了<%:ViewData["复合型听力"]%>个题目，请选择相应的听力文件：</h3>
