...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="menu">
        ...
        =>
        <%:Html.ActionLink("年级信息修改", "EditTGrade")%>
    </div>
    <fieldset>
        <legend>年级信息修改：</legend>
            ...
            $("#GradeName").rules("add", {
                ...
                remote: {
                    ...
                    data: {
                        ...
                        MajorID: function () { if ($("#MajorID").val() == "00000000-0000-0000-0000-000000000000") return null; else return $("#MajorID").val(); },
                        GradeID: function () { return $("#GradeID").val() }
                    },
                    dataType: "html",
