    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                m.each(function (i) {
                    if ($(this).text() == data.Info.Diffcult) {
                        $(this).attr("selected", true);
                    }
                })
                for (var s = 0; s < 15; s++) {
                    var div1 = "<br/>";
                    div1 = div1 + "<input type='text' id='Option" + (s + 1) + "'" + "name='Option" + (s + 1) + "'" + "value='" + data.WordList[s] + "'" + "style='width:800px'/>";
                    $("#div1").append(div1);
                    $("#Option" + (s + 1)).val(data.WordList[s]);
                }
                ...
                for (var i = 0; i < num; i++) {
                    ...
                    div = div + "<br/>";
                    div = div + "&nbsp;答案：&nbsp;";
                    div = div + "<input type='text'" + "id='textanswer" + (i + 1) + "'" + "name='textanswer" + (i + 1) + "'" + "value='" + data.Info.AnswerValue[i] + "'" + "style='width:800px'>";
                    div = div + "</br>";
