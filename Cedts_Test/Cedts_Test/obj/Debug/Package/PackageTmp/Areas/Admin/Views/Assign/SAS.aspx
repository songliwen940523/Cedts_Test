        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < num; i++) {
                    ...
                    div = div + "<br/>";
                    div = div + "<a href='#' class='classa' id='a" + (i + 1) + "'" + " >请选择知识点</a><span id='span" + (i + 1) + "'" + "'" + "class='" + "span" + "'style='display:none'" + ">" + data.Info.Knowledge[i] + "</span><input class='hidden' type='hidden' id='hidden" + (i + 1) + "'" + " name='hidden" + (i + 1) + "'" + "value=" + "'" + data.Info.KnowledgeID[i] + "'" + " />";
                    div = div + "<br/>";
                    div = div + "<input type='hidden' id='OldKPID" + (i + 1) + "'" + "name='OldKPID" + (i + 1) + "'" + "value='" + data.Info.KnowledgeID[i] + "'/>"; div = div + "&nbsp;答案：&nbsp;";
                ...
                for (var k = 0; k < termnum; k++) {
                    ...
                    var div1 = "<br/>"
                    div1 = div1 + "<fieldset style='width: 900px'><legend>第" + (k + num + 1) + "小题：</legend>";
                    div1 = div1 + "<br/>";
                    div1 = div1 + "题目:";
                    div1 = div1 + "&nbsp;&nbsp;<input class='question' type='text' id=" + "'" + "Question" + (k + num + 1) + "'" + "name=" + "'" + "Question" + (k + num + 1) + "'" + "value=" + "'" + data.Info.Problem[(k + num)] + "'" + "style='width:800px'/>"
                    div1 = div1 + "<input type='hidden' id='OldQuestionID" + (k + num + 1) + "'" + "name='OldQuestionID" + (k + num + 1) + "'" + "value='" + data.Info.QuestionID[(k + num)] + "'/>";
                    div1 = div1 + "<br/>";
                    div1 = div1 + "<a href='#' class='classa' id='a" + (k + num + 1) + "'" + " >请选择知识点</a><span id='span" + (k + num + 1) + "'" + "'" + "class='" + "span" + "'style='display:none'" + ">" + data.Info.Knowledge[(k + num)] + "</span><input class='hidden' type='hidden' id='hidden" + (k + num + 1) + "'" + " name='hidden" + (k + num + 1) + "'" + "value=" + "'" + data.Info.KnowledgeID[k + num] + "'" + " />";
                    div1 = div1 + "<input type='hidden' id='OldKPID" + (k + num + 1) + "'" + "name='OldKPID" + (k + num + 1) + "'" + "value='" + data.Info.KnowledgeID[k + num] + "'/>";
                    div1 = div1 + "</br>";
                    div1 = div1 + "&nbsp;答案：&nbsp;";
                    div1 = div1 + "<input type='text'" + "id='textanswer" + (k + num + 1) + "'" + "name='textanswer" + (k + num + 1) + "'" + "value='" + data.Info.AnswerValue[k + num] + "'" + "style='width:800px'>";
                    div1 = div1 + "</br>";
                    div1 = div1 + "答案解析：<input type='text' id='tip" + (k + num + 1) + "'" + "name='" + "tip" + (k + num + 1) + "'" + "value=" + "'" + data.Info.Tip[(k + num)] + "'" + "style='width:800px'/>";
                    div1 = div1 + "</br>";
                    $("#divi1").append(div1);
                ...
                var qname1 = questionids + questionids1;
