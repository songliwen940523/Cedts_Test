...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.post("/admin/paper/GetMultipleChoice", null, function (data) {
                if (data == "1") { }
                else {
    ...
    <div>
        ...
        <div id="menu">
            ...
            =>
            <%:Html.ActionLink("试卷阅读选择添加","CreateMultipleChoice") %>
        </div>
        ...
        <input type="hidden" id="hidden" name="hidden" value='<%:ViewData["阅读选择题型"] %>' />
