        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var k = 0; k < termnum; k++) {
                    ...
                    div1 = div1 + "<br/>";
                    div1 = div1 + "<a href='#' class='classa' id='a" + (k + num + 1) + "'" + " >请选择知识点</a><span id='span" + (k + num + 1) + "'" + "'" + "class='" + "span" + "'style='display:none'" + ">" + data.Info.Knowledge[(k + num)] + "</span><input class='hidden' type='hidden' id='hidden" + (k + num + 1) + "'" + " name='hidden" + (k + num + 1) + "'" + " />";
