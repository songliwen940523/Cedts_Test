...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%: Html.ValidationSummary(true)%>
        ...
        =>
        <%:Html.ActionLink("修改复合型听力","EditCloze") %>
    </div>
    <div>
    复合听力原文:
        <div>
        ...
        <div>
            ...
            听力时间间隔：<input type="text" class='interval' id="interval" name="interval" onkeypress="keyPress()" /><br />
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < num; i++) {
                    ...
                    div = div + "<br/>";
                    div = div + "&nbsp;答案：&nbsp;";
                    div = div + "<input class='answer' type='text' id=" + "'" + "textanswer" + (i + 1) + "'" + "name=" + "'" + "textanswer" + (i + 1) + "'" + "value='" + data.Info.AnswerValue[i] + "'" + "/>"
                    div = div + "</select>";
                    div = div + "</br>";
