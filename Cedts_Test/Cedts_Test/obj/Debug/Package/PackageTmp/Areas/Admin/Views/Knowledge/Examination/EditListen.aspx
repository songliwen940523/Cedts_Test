...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="menu">
        ...
        =>
        <%:Html.ActionLink("修改听力题型","EditListen") %>
    </div>
    <div>
        听力原文:
        <div>
        ...
        <div>
            ...
            答题估时：<input type="text" id="time" name="time" /><br />
            难度：&nbsp;&nbsp;
        ...
        <div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="submit" id="submit" onclick="return check();" value="确定" />
        </div>
        <div>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            type: "POST",
            url: "/Admin/Examination/GetListen",
            data: { id: id },
            datatype: "json",
            success: function (data) {
                ...
                $("#interval").val(data.Info.QustionInterval);
                ...
                for (var i = 0; i < num; i++) {
                    ...
                    div = div + "<br/>";
                    if (data.Info.ItemType_CN != "5" && data.Info.ItemType_CN != "2") {
                        div = div + "时间间隔：<input type='text' class='interval' id='interval" + (i + 1) + "' name='interval" + (i + 1) + "' onkeypress='keyPress()' value='" + data.Info.timeInterval[i] + "' /><br />";
                    }
                    div = div + "选项:" + "&nbsp;" + "A";
